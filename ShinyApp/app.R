...
ui <- dashboardPage(
  ...
  dashboardSidebar(width = 320,
    ...
    pickerInput(
      "result_type", label = "Choose the types of results reported:",
    ...
    # Input: Choose brand
    pickerInput(
      "wearable_brand", label = "Wearable brands used most often (≥5):",
  ...
  dashboardBody(
    ...
    tabBox(width = 12,
      ...
      tabPanel("Type of sensor and position",
        fluidRow(
          box(
