...
# View exact Title duplicates (probably better to resolve them manually)
#table(duplicated(merged[c("Title")]))
#View(merged[merged$Title %in% merged$Title[duplicated(merged[c("Title")])], c("Title", "Abstract", "DOI", "database")])

#write.csv(merged[order(merged$`Publication Year`, merged$Title),], "21-03-18 merged 1051.csv")
```
